%% NOTE: Run the Getting_data_structure.m before running this script
for ii=3:length(D)
    for jj=3: 2 + DL(ii-2)
...
%clc; clear all
%cd '/Users/rahulchajwa/Documents/Maine-PIV/PIVlab'
...
% default directory: PIVlab/Examples  // this was already commented out
...
%directory= '/Users/rahulchajwa/Documents/Maine-PIV/Image_registration_3dPIV-2021-06-21-80m/registered_output/_2021-06-21 23-09-46'; %directory containing the images you want to analyze
directory=strcat(SubFolder{ii,jj},'/registered_output'); %directory containing the images you want to analyze
% default directory: PIVlab/Examples
%addpath('/Users/rahulchajwa/Documents/Maine-PIV/Image_registration_3dPIV-2021-06-21-80m/registered_output/_2021-06-21 23-09-46');
addpath(directory);
%disp(fileparts(mfilename('fullpath')))
image_path = strcat(directory,'/*.tif');
suffix='*.tif'; %*.bmp or *.tif or *.jpg or *.tiff or *.jpeg
%disp(['Looking for ' suffix ' files in the selected directory.']);
%direc = dir('/Users/rahulchajwa/Documents/Maine-PIV/Image_registration_3dPIV-2021-06-21-80m/registered_output/_2021-06-21 23-09-46/*.tif'); filenames={};
direc = dir(image_path); filenames={};
[filenames{1:length(direc),1}] = deal(direc.name);
filenames = sortrows(filenames); %sort all image files
amount = length(filenames);
...
%%
clearvars -except p s r x y u v typevector directory filenames u_filt v_filt typevector_filt correlation_map ii jj D SubFolder DL
disp('DONE.')
    end
end
